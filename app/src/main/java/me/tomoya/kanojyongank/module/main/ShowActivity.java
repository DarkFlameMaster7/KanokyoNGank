...
import me.tomoya.kanojyongank.module.main.adapter.KanojyoPagerAdapter;
...
public class ShowActivity extends BaseActivity {
	...
	@Bind(R.id.rhythm_view)   RhythmView  rhythmView;
	...
	* */
	...
	private void loadData(int page) {
		Subscription subscription =
				Observable.zip(gankApi.getKanojyoData(page), gankApi.getShortFilmData(page),
	...
	private void isRocketBtnShow(int position) {
		if (position > 1) {
			...
			AnimatorUtils.animFadeOut(this.ibtnRocket)
